...
{/* <!-- preloader area start --> */}
    ...
    <header className="navbar-area">
        <nav className="navbar navbar-expand-lg">
            <div className="container nav-container">
                ...
                <div className="logo">
                    <a className="main-logo" href="home-1.html"><img src="assets/img/logo.png" alt="img"></img></a>
                </div>
    ...
    <section className="banner-area">
        <div className="banner-thumb">
            <img src="assets/img/banner/banner.png" alt="img"></img>
        </div>
        <div className="banner-bg-img"></div>
        <div className="banner-shape-1"><img src="assets/img/banner/shape-1.png" alt="img"></img></div>
        <div className="banner-shape-2"><img src="assets/img/banner/shape-2.png" alt="img"></img></div>
            ...
            <div className="row justify-content-center">
                <div className="col-lg-12 align-self-center">
                    <ul className="category-menu">
                        <li className="category-wrap"><a href="shop.html"><img src="assets/img/category/1.png" alt="category"></img>Ramen</a>
                            
                        </li>
                        <li className="category-wrap"><a href="#"><img src="assets/img/category/2.png" alt="category"></img>Pizza</a>
                            <div className="category-sub-menu">
                                <div className="row">
                                    <div className="col-md-3 col-6">
                                        <div className="single-item-wrap text-center">
                                            <div className="thumb">
                                                <img src="assets/img/product/pizza/1.png" alt="img"></img>
                                            </div>
                                    ...
                                    <div className="col-md-3 col-6">
                                        <div className="single-item-wrap text-center">
                                            <div className="thumb">
                                                <img src="assets/img/product/pizza/2.png" alt="img"></img>
                                            </div>
                                            <div className="wrap-details">
                                    ...
                                    <div className="col-md-3 col-6">
                                        <div className="single-item-wrap text-center">
                                            <div className="thumb">
                                                <img src="assets/img/product/pizza/3.png" alt="img"></img>
                                            </div>
                                            <div className="wrap-details">
                                                <h6><a href="shop.html">Margherita Pizza</a></h6>                          
                                            </div> 
                                    ...
                                    <div className="col-md-3 col-6">
                                        <a href="#"><img src="assets/img/ad.png" alt="img"></img></a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li className="category-wrap"><a href="#"><img src="assets/img/category/3.png" alt="category"></img>Burger</a>
                            <div className="category-sub-menu">
                                <div className="row">
                                    <div className="col-md-3 col-6">
                                        <div className="single-item-wrap text-center">
                                            <div className="thumb">
                                                <img src="assets/img/product/burger/1.png" alt="img"></img>
                                            </div>
                                            <div className="wrap-details">
                        ...
                        <li className="category-wrap"><a href="shop.html"><img src="assets/img/category/4.png" alt="category"></img>French fries</a>
                            
                        </li>
                        <li className="category-wrap"><a href="shop.html"><img src="assets/img/category/5.png" alt="category"></img>Fast food</a>
                            
                        </li>
                        <li className="category-wrap"><a href="shop.html"><img src="assets/img/category/6.png" alt="category"></img>Soft drinks</a>
            ...
            <div className="row justify-content-center">
                <div className="col-md-6 align-self-center d-contents">
                    <div className="single-offer-wrap" style={{backgroundColor: "var(--main-color)"}} >
                        <img className="bg-img" src="assets/img/offer/1.png" alt="img"></img>
                        <div className="wrap-details">
                        ...
                        <div className="offer-sticker">
                            <img src="assets/img/offer/offer.png" alt="img"></img>
                        </div>
                    </div>
                </div>
                <div className="col-md-6 align-self-center">
                    <div className="single-offer-wrap" style={{backgroundColor: "var(--heading-color)"}}>
                        <img className="bg-img" src="assets/img/offer/2.png" alt="img"></img>
                        <div className="wrap-details">
                    ...
                    <div className="single-offer-wrap" style={{backgroundColor: '#FFEECC'}}>
                        <div className="animated-img"><img src="assets/img/offer/03.png" alt="img"></img></div>
                        <div className="animated-img animated-img-2"><img src="assets/img/offer/03.png" alt="img"></img></div>
                        <div className="overlay-gradient"></div>
                        <div className="wrap-details">
                            <h3 className="text-heading">The Fastest In Delivery <span>Food</span></h3>
                            <a className="btn btn-white" href="shop.html">ORDER NOW</a>
                        </div>
                        <img className="bg-img-2" src="assets/img/offer/3.png" alt="img"></img>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="row justify-content-center">
                <div className="col-lg-6">
                    <div className="thumb mb-lg-0 mb-4">
                        <img src="assets/img/other/about.png" alt="img"></img>
                    </div>
                </div>
                <div className="col-lg-6">
                    ...
                    <div className="row">
                        <div className="col-sm-6">
                            <div className="single-about-wrap">
                                <img src="assets/img/icon/1.png" alt="img"></img>
                                Fresh food
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="single-about-wrap">
                                <img src="assets/img/icon/2.png" alt="img"></img>
                                Fast Delivery
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="single-about-wrap">
                                <img src="assets/img/icon/3.png" alt="img"></img>
                                Quality Maintain
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="single-about-wrap">
                                <img src="assets/img/icon/4.png" alt="img"></img>
                                24/7 Service
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-12">
                    ...
                    <ul className="product-nav nav nav-pills" id="pills-tab" role="tablist">
                        <li className="nav-item" role="presentation">
                          <button className="nav-link active" id="pills-ramen-tab" data-bs-toggle="pill" data-bs-target="#pills-ramen" type="button" role="tab" aria-controls="pills-ramen" aria-selected="true"><img src="assets/img/category/1.png" alt="img"></img>Ramen</button>
                        </li>
                        <li className="nav-item" role="presentation">
                          <button className="nav-link" id="pills-pizza-tab" data-bs-toggle="pill" data-bs-target="#pills-pizza" type="button" role="tab" aria-controls="pills-pizza" aria-selected="false"><img src="assets/img/category/2.png" alt="img"></img>Pizza</button>
                        </li>
                        <li className="nav-item" role="presentation">
                          <button className="nav-link" id="pills-burger-tab" data-bs-toggle="pill" data-bs-target="#pills-burger" type="button" role="tab" aria-controls="pills-burger" aria-selected="false"><img src="assets/img/category/3.png" alt="img"></img>Burger</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className="nav-link" id="pills-french-fry-tab" data-bs-toggle="pill" data-bs-target="#pills-french-fry" type="button" role="tab" aria-controls="pills-french-fry" aria-selected="false"><img src="assets/img/category/4.png" alt="img"></img>French fries</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className="nav-link" id="pills-fast-food-tab" data-bs-toggle="pill" data-bs-target="#pills-fast-food" type="button" role="tab" aria-controls="pills-fast-food" aria-selected="false"><img src="assets/img/category/5.png" alt="img"></img>Fast food</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className="nav-link" id="pills-drinks-tab" data-bs-toggle="pill" data-bs-target="#pills-drinks" type="button" role="tab" aria-controls="pills-drinks" aria-selected="false"><img src="assets/img/category/6.png" alt="img"></img>Soft drinks</button>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div className="tab-pane fade" id="pills-pizza" role="tabpanel" aria-labelledby="pills-pizza-tab">
                    <div className="row justify-content-center">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-item-wrap">
                                <div className="thumb">
                                    <img src="assets/img/product/pizza/4.png" alt="img"></img>
                                    <a className="fav-btn" href="#"><i className="ri-heart-line"></i></a>
                                </div>
                                <div className="wrap-details">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-item-wrap">
                                <div className="thumb">
                                    <img src="assets/img/product/pizza/5.png" alt="img"></img>
                                    <a className="fav-btn" href="#"><i className="ri-heart-line"></i></a>
                                </div>
                                <div className="wrap-details">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-item-wrap">
                                <div className="thumb">
                                    <img src="assets/img/product/pizza/6.png" alt="img"></img>
                                    <a className="fav-btn" href="#"><i className="ri-heart-line"></i></a>
                                </div>
                                <div className="wrap-details">
                                    <h5><a href="single-product.html">BBQ Chicken classNameic Pizza Large </a></h5>
                                    <div className="wrap-footer">
                                        <div className="rating">
                                            4.9
                                            <span className="rating-inner">
            ...
            <div className="row justify-content-center">
                <div className="col-lg-4 col-md-6">
                    <div className="single-blog-wrap">
                        <div className="thumb">
                            <img src="assets/img/blog/1.png" alt="img"></img>
                        </div>
                        <div className="wrap-details">
                            <span className="cat">
                                <span className="date">
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="single-blog-wrap">
                        <div className="thumb">
                            <img src="assets/img/blog/2.png" alt="img"></img>
                        </div>
                        <div className="wrap-details">
                            <span className="cat">
                                <span className="date">
                ...
                <div className="col-lg-4 col-md-6">
                    <div className="single-blog-wrap">
                        <div className="thumb">
                            <img src="assets/img/blog/3.png" alt="img"></img>
                        </div>
                        <div className="wrap-details">
                            <span className="cat">
                                <span className="date">
                ...
                <div className="row">
                    <div className="col-lg-3 col-sm-6">
                        <div className="footer-widget widget">
                            <div className="logo">
                                <img src="assets/img/logo.png" alt="img"></img>
                            </div>
                            <ul className="contact_info_list">
                                ...
                                <li className="single-info-item">
                                    <img src="assets/img/icon/envelope.png" alt="icon"></img>
                                    <div className="details">
                                        ordernow@foodka.com
                                    </div>
                                </li>
                                <li className="single-info-item">
                                    <img src="assets/img/icon/phone.png" alt="icon"></img>
                                    <div className="details">
                                        +997 509 153 849
                                    </div>
                                </li>
